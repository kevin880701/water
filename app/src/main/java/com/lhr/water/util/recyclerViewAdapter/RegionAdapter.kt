...
import com.lhr.water.databinding.ItemRegionBinding

class RegionAdapter(val listener: Listener): ListAdapter<String, RegionAdapter.ViewHolder>(LOCK_DIFF_UTIL) {
