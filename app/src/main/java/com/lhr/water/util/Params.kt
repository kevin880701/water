...
val MapDataList: List<RegionEntity> =
    listOf(
        ...
        RegionEntity(regionName="第一區管理處", regionNumber="01", deptName="一區物料課", deptNumber="01", mapSeq=1),
        ...
        RegionEntity(regionName="第九區管理處", regionNumber="09", deptName="九區物料課", deptNumber="09", mapSeq=1),
        ...
        RegionEntity(regionName="第二區管理處", regionNumber="02", deptName="二區物料課", deptNumber="02", mapSeq=1),
        RegionEntity(regionName="第二區管理處", regionNumber="02", deptName="二區物料課", deptNumber="02", mapSeq=2),
        ...
        RegionEntity(regionName="第五區管理處", regionNumber="05", deptName="嘉義服務所", deptNumber="0521", mapSeq=1),
        ...
        RegionEntity(regionName="第八區管理處", regionNumber="08", deptName="八區物料課", deptNumber="08", mapSeq=1),
        RegionEntity(regionName="第八區管理處", regionNumber="08", deptName="八區物料課", deptNumber="08", mapSeq=2),
        ...
        RegionEntity(regionName="第十一區管理處", regionNumber="0B", deptName="十一區物料課", deptNumber="0B", mapSeq=1),
        RegionEntity(regionName="第十一區管理處", regionNumber="0B", deptName="十一區物料課", deptNumber="0B", mapSeq=2),
        RegionEntity(regionName="第十一區管理處", regionNumber="0B", deptName="十一區物料課", deptNumber="0B", mapSeq=3),
        RegionEntity(regionName="第十一區管理處", regionNumber="0B", deptName="十一區物料課", deptNumber="0B", mapSeq=4),
        ...
        RegionEntity(regionName="第十二區管理處", regionNumber="0C", deptName="十二區物料課", deptNumber="0C", mapSeq=1),
        RegionEntity(regionName="第十二區管理處", regionNumber="0C", deptName="十二區物料課", deptNumber="0C", mapSeq=2),
        RegionEntity(regionName="第十二區管理處", regionNumber="0C", deptName="十二區物料課", deptNumber="0C", mapSeq=3),
